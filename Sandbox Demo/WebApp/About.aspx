...
<%--    Tips:
 ...
 <%-- The AssociatedControlID attribute/property must have a value that is the ID of another control on the form --%>
...
<%--    The OnClick that i specift here associates the click event of the button with a
    ...
    <asp:DropDownList ID="CareerPath" runat="server">
        ...
        <asp:ListItem Value="Acceptable">Business Analyst</asp:ListItem>
    ...
    <asp:CheckBoxList ID="Languages" runat="server">
        ...
        <asp:ListItem Value="VB">Visual Basics</asp:ListItem>
